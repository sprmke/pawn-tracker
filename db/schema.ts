...
export const loanStatusEnum = pgEnum('loan_status', ['Active', 'Done', 'Overdue']);
export const transactionTypeEnum = pgEnum('transaction_type', ['Pawn', 'Salary', 'Credit Card', 'Debt', 'Others']);
...
export const loans = pgTable("loans", {
  ...
  defaultInterestRate: decimal("default_interest_rate", { precision: 5, scale: 2 }).notNull().default('10.00'),
...
export const loanInvestors = pgTable("loan_investors", {
  ...
  investorId: integer("investor_id").references(() => investors.id, { onDelete: 'cascade' }).notNull(),
