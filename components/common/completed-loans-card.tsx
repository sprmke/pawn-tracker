            ...
            {loans.length > 0 && (
              <button
                ...
                className={cn(
                  ...
                  onViewAllClick &&
                    'hover:bg-chart-1/20 hover:text-chart-1 cursor-pointer',
                )}
                title="View all completed loans"
              >
                {loans.length}
              </button>
            )}
              ...
              <>
                ...
                <div className="space-y-2 max-h-[320px] overflow-y-auto pr-1">
                  {displayLoans.map((loan) => {
                    ...
                    const cardClassName =
                      'flex flex-col p-3 border-2 border-chart-1/20 bg-background rounded-xl hover:bg-chart-1/5 hover:shadow-md transition-all duration-300 gap-1 cursor-pointer';
